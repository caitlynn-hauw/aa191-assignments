...
function addMarker(latitude, longitude, name, title, message){
    if(title == 'Yes'){
    ...
    new maplibregl.Marker()
        ...
        .addTo(map)
    createButtons(latitude, longitude, name)
}
...
function processData(results){
    ...
    results.forEach(feature => {
        ...
        let lng = feature.lng;
        let lat = feature.lat;
        let title = feature["do you like albert's puns?"];
        let name = feature["what is your first name?"]
        let message = feature['why do you feel this way about his puns?'];
        addMarker(lat,lng,name,title,message);
    });
};